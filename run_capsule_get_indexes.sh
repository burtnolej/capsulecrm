...
python -m pdb $DIRCAPSULEPY/capsule_get_entity_indexes.py entity="organisation" entity_key="Company__Type" subentity_key="None" pickle_dir=$DIRCAPSULEPICKLEINDEX
