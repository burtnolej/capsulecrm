...
#python $DIRCAPSULEPY/capsule_dump_web_entity.py multipage=100000 entity="entries" persistfile="$DIRCAPSULEPICKLE/entries.pickle" start_page=0 pickle_dir="$DIRCAPSULEPICKLE"

#python $DIRCAPSULEPY/capsule_dump_web_entity.py multipage=100000 entity=parties persistfile="$DIRCAPSULEPICKLE/organisation.pickle" start_page=0 filter=organisation_filter pickle_dir=$DIRCAPSULEPICKLE

#python $DIRCAPSULEPY/capsule_dump_web_entity.py multipage=100000 entity=opportunities persistfile="$DIRCAPSULEPICKLE/opportunities.pickle" start_page=0 pickle_dir=$DIRCAPSULEPICKLE

python $DIRCAPSULEPY/capsule_dump_web_entity.py filter=person_filter multipage=10 entity=parties persistfile="$DIRCAPSULEPICKLE/person_1.pickle" start_page=0 pickle_dir=$DIRCAPSULEPICKLE
